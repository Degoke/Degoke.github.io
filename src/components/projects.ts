...
const projects: ProjectType[] = [
  {
    title: "Dekube Core",
    details:
      "A paas for deploying applications to kubernetes, acts as the core for Dekube application. <br>Built with golang, gin and kubernetes-client-go. ",
  ...
  {
    title: "Doc Verify",
    details: `Document analysis and image comparison application for identity verification <br> Built with golang, gin, aws-sdk-go, gorm, mongodb`,
  ...
  },
  {
    title: "ETH Service",
    details:
      "A service for managing Accounts and Transactions on Ethereum. <br> Built with NestJS, web3.js, MongoDB for data persistence and Ganache for a local node.",
  ...
  },
  {
    ...
    details:
      "An account management application, for sending and receiving money.<br> Built with Nest js and MongoDB",
  ...
  },
  {
    ...
    details:
      "The ui of the account management application.<br>Built with React and Material UI",
  ...
  },
  {
    ...
    details: `Minimalist dark mode portfolio website to show my works<br>
